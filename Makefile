...
lint-py:  ## lint python with ruff
	python -m ruff check python_fsspec
	python -m ruff format --check python_fsspec
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix python_fsspec
	python -m ruff format python_fsspec
...
test:  ## run python tests
	python -m pytest -v python_fsspec/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v python_fsspec/tests --cov=python_fsspec --cov-report term-missing --cov-report xml
